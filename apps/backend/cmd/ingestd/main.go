// Command ingestd is the Backend ingest service scaffold. It demonstrates the
// "thin assembly" idea: it wires the SAME shared ingest engine and Ingest
// ConnectRPC handler as Edge, but against an EXTERNAL NATS server instead of an
...
// ingestService is the same handler shape Edge uses; Backend simply assembles
