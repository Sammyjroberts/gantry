...
// install hint and everything else in Bench keeps working.
package duckdb
...
// <dataDir>/duckdb/duckdb(.exe). This is how Bench ships it alongside ./data.
...
// DefaultProvider is the standard Bench resolution order: explicit env override
