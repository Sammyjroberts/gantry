...
func TestRequiredScope(t *testing.T) {
	cases := []struct {
		...
		// Evals: reads → read, mutations → operate, verdict → verify, promote → admin.
		{"POST", "/gantry.v1.EvalService/StartRun", ScopeOperate, true},
		{"POST", "/gantry.v1.EvalService/OpenTrial", ScopeOperate, true},
		{"POST", "/gantry.v1.EvalService/EvaluateGate", ScopeOperate, true},
		{"POST", "/gantry.v1.EvalService/GetRun", ScopeRead, true},
		{"POST", "/gantry.v1.EvalService/ListSuites", ScopeRead, true},
		{"POST", "/gantry.v1.EvalService/SubmitVerdict", ScopeVerify, true},
		{"POST", "/gantry.v1.EvalService/PromoteBaseline", ScopeAdmin, true},
		// Stations: discovery → read, register/lease → operate.
		{"POST", "/gantry.v1.StationService/ListStations", ScopeRead, true},
		{"POST", "/gantry.v1.StationService/CheckTarget", ScopeRead, true},
		{"POST", "/gantry.v1.StationService/Lease", ScopeOperate, true},
		{"POST", "/gantry.v1.StationService/RegisterStation", ScopeOperate, true},
