...
// of Bench persistence (ARCHITECTURE.md "Bench: JetStream tail + Parquet segments
...
// the requested window. It is pure Go — parquet-go, no CGo — so Bench stays a
// single cross-compilable static binary. Cloud later wires the SAME Writer to
