//! Connect/HTTP transport for the Gantry Connect SDK.
//!
//! Implements [`gantry_connect::Transport`] against the ConnectRPC unary protocol:
...
/// A Connect/HTTP transport pointed at a single ingest endpoint (Edge or Backend).
